...
exports.default = function (resourceUrl, resourceInitialState) {
  var configure = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : { query: null, refetch: false, changeQuery: false };
