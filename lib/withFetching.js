              ...
              effectProps[efk] = function (data) {
                ...
                if (typeof effects[efk] === 'function') {
                  ...
                  if ((0, _pIsPromise2.default)(res)) {
                    res.then(function (x) {
                      return _this2.setState(_defineProperty({}, resourceName, x));
                    });
                  } else {
                    this.setState(_defineProperty({}, resourceName, res));
                  }
                } else {
                  this.setState(_defineProperty({}, resourceName, Object.assign({}, effects[efk], data)));
                }
              };
            };
