...
exports.default = function (getForFetching, resourceUrl, resourceInitialState) {
  var configure = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : { query: null, refetch: false, changeQuery: false, effects: false };
  ...
  return function (BaseComponent) {
    ...
    return function (_Component) {
      ...
      function _class2(props) {
            ...
            var _loop = function _loop() {
              ...
              effectProps[efk] = function (data) {
                if (typeof effects[efk] === 'function') {
                  var res = effects[efk](data);
                  if ((0, _pIsPromise2.default)(res)) {
                    res.then(function (x) {
                      return _this.setState(_defineProperty({}, resourceName, x));
                    });
                  } else {
                    _this.setState(_defineProperty({}, resourceName, res));
                  }
                } else {
                  _this.setState(_defineProperty({}, resourceName, Object.assign({}, effects[efk], data)));
                }
              };
            };

            for (var _iterator = effectkeys[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              _loop();
            }
          } catch (err) {
        ...
        _this.state = Object.assign({}, _extends({}, resourceInitialState), { query: query }, _extends({}, refetchProp), _extends({}, changeQueryProp), _extends({}, effectProps));
        return _this;
      }
